    ...
    return z
        .object({
			...
			*/
            ...
            Head: z
                .string()
                .default("@/starlight/components/Head.astro"),
            ...
            ThemeProvider: z
                .string()
                .default("@/starlight/components/ThemeProvider.astro"),
			...
			*/
            ...
            SkipLink: z
                .string()
                .default("@/starlight/components/SkipLink.astro"),
			...
			*/
            ...
            PageFrame: z
                .string()
                .default("@/starlight/components/PageFrame.astro"),
            /**
            ...
            MobileMenuToggle: z
                .string()
                .default(
                    "@/starlight/components/MobileMenuToggle.astro",
                ),
            ...
            TwoColumnContent: z
                .string()
                .default(
                    "@/starlight/components/TwoColumnContent.astro",
                ),
			...
			*/
            ...
            Header: z
                .string()
                .default("@/starlight/components/Header.astro"),
            /**
            ...
            SiteTitle: z
                .string()
                .default("@/starlight/components/SiteTitle.astro"),
            /**
            ...
            Search: z
                .string()
                .default("@/starlight/components/Search.astro"),
            /**
            ...
            SocialIcons: z
                .string()
                .default("@/starlight/components/SocialIcons.astro"),
            /**
            ...
            ThemeSelect: z
                .string()
                .default("@/starlight/components/ThemeSelect.astro"),
            /**
            ...
            LanguageSelect: z
                .string()
                .default("@/starlight/components/LanguageSelect.astro"),
			...
			*/
            ...
            Sidebar: z
                .string()
                .default("@/starlight/components/Sidebar.astro"),
            /**
            ...
            MobileMenuFooter: z
                .string()
                .default(
                    "@/starlight/components/MobileMenuFooter.astro",
                ),
			...
			*/
            ...
            PageSidebar: z
                .string()
                .default("@/starlight/components/PageSidebar.astro"),
            /**
            ...
            TableOfContents: z
                .string()
                .default("@/starlight/components/TableOfContents.astro"),
            /**
            ...
            MobileTableOfContents: z
                .string()
                .default(
                    "@/starlight/components/MobileTableOfContents.astro",
                ),
			...
			*/
            ...
            Banner: z
                .string()
                .default("@/starlight/components/Banner.astro"),
            ...
            ContentPanel: z
                .string()
                .default("@/starlight/components/ContentPanel.astro"),
            ...
            PageTitle: z
                .string()
                .default("@/starlight/components/PageTitle.astro"),
            ...
            FallbackContentNotice: z
                .string()
                .default(
                    "@/starlight/components/FallbackContentNotice.astro",
                ),
            ...
            DraftContentNotice: z
                .string()
                .default(
                    "@/starlight/components/DraftContentNotice.astro",
                ),
            ...
            Hero: z
                .string()
                .default("@/starlight/components/Hero.astro"),
			...
			*/
            ...
            MarkdownContent: z
                .string()
                .default("@/starlight/components/MarkdownContent.astro"),
			...
			*/
            ...
            Footer: z
                .string()
                .default("@/starlight/components/Footer.astro"),
            /**
            ...
            LastUpdated: z
                .string()
                .default("@/starlight/components/LastUpdated.astro"),
            /**
            ...
            Pagination: z
                .string()
                .default("@/starlight/components/Pagination.astro"),
            /**
            ...
            EditLink: z
                .string()
                .default("@/starlight/components/EditLink.astro"),
        })
        .default({});
}
