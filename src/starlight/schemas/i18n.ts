...
function starlightI18nSchema() {
    return z
        .object({
            ...
            "aside.tip": z
                .string()
                .describe("Text shown on the tip aside variant"),
            "aside.note": z
                .string()
                .describe("Text shown on the note aside variant"),
            "aside.caution": z
                .string()
                .describe("Text shown on the warning aside variant"),
            "aside.danger": z
                .string()
                .describe("Text shown on the danger aside variant"),
            ...
            "heading.anchorLabel": z
                .string()
                .describe("Label for anchor links in Markdown content."),
        })
        .partial();
}
