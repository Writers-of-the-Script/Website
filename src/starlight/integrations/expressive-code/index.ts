...
export type StarlightExpressiveCodeOptions = Omit<
        ...
        astroExpressiveCode({
            ...
            customConfigPreprocessors: {
                preprocessAstroIntegrationConfig:
                    getStarlightEcConfigPreprocessor({
                        starlightConfig,
                        useTranslations,
                    }),
                preprocessComponentConfig: `
					import starlightConfig from 'virtual:starlight/user-config'
					import { useTranslations, getStarlightEcConfigPreprocessor } from '@/starlight/internal'
