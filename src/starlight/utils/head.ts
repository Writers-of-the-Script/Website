...
const titleWithoutIcons = data.title.replaceAll(/\s*\[.+\]\s*/gm, "");
    ...
    const headDefaults: HeadUserConfig = [
        ...
        {
            tag: "meta",
            attrs: { name: "generator", content: context.generator },
        },
        {
            tag: "meta",
            attrs: { name: "generator", content: "NulledLight" },
        },
        // Favicon
        {
            tag: "link",
        ...
        {
            tag: "meta",
            attrs: { property: "og:site_name", content: siteTitle },
        },
        // Twitter Tags
        {
            tag: "meta",
        ...
        for (const locale in config.locales) {
            ...
            headDefaults.push({
                ...
                attrs: {
                    ...
                    href: localizedUrl(canonical, locale, project.trailingSlash)
                        .href,
                },
            });
        }
