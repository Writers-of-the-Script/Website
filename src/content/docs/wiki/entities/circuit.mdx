...
<Steps>
1. Loud.
2. It has been confirmed that a lot of the deaths from TBS seem to be associated with Circuit. One in particular is rather gruesome and troubling. Circuit killed [Revuxor](./revuxor) IRL, having left Revuxor's computer from the screen and invaded his home before ripping him apart.
