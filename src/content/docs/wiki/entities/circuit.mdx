...
<Tabs>
    <TabItem label="Gallery">
        <CaptionedImage src="../assets/wiki/Circuit lurking.png">
            Photo taken seconds before disaster
        </CaptionedImage>

        <CaptionedImage src="../assets/wiki/CircuitsHorde.png">
            Results of a foolish attempt to enable devmode in 1.9.3
        </CaptionedImage>

        <CaptionedImage src="../assets/wiki/Circuitstolenullbread.png">
            Looore
        </CaptionedImage>
    </TabItem>

    <TabItem label="Sounds">
        <CaptionedAudio src="../assets/wiki/Circuitjumpscare.ogg">
            Jumpscare
        </CaptionedAudio>

        <CaptionedAudio src="../assets/wiki/Nulljumpscareoverhaul.ogg">
            Chase
        </CaptionedAudio>

        <CaptionedAudio src="../assets/wiki/Youwillregretthat.ogg">
            Hurt sound (Stalk)
        </CaptionedAudio>
    </TabItem>
</Tabs>
